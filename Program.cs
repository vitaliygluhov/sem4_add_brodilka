...
Console.Clear();
Console.WriteLine("Легенда карты: \r\nСиний - вода (замедляет движение в 3 раза, отнимает 3 сытости);\r\nЗеленый - равнина (не замедляет движение, отнимает 1 сытость);\r\nСерый - скалы (не доступно для перемещения);\r\n w - кусты. замедление в 2 раза, отнимает 2 сытости;\r\n \\|/ - деревья (замедляет в 3 раза, отнимает 3 сытости;\r\n *** - еда (дает 20 сытости);\r\n ]+[ - игрок;\r\n [O] - цель");
